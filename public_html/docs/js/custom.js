$(document).ready(function () {
  ...
  $(".js-status-select").on("click", function (e) {
    e.stopPropagation();
  });
  ...
  $(".lk-burger").click(function () {
    if ($(this).hasClass("lk-burger_down"))
      $(this).removeClass("lk-burger_down");
  ...
  $(".b-user__ico").click(function () {
    if ($(".b-user").hasClass("b-user_active"))
      $(".b-user").removeClass("b-user_active");
